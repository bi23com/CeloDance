...
List<dynamic> _encodeToRlp(Transaction transaction, MsgSignature signature) {
  ...
  if(transaction.feeCurrency != null){
    list.add(transaction.feeCurrency.addressBytes);
  }else{
    list.add(Uint8List(0));
  }
  if(transaction.gatewayFeeRecipient != null){
    list.add(transaction.gatewayFeeRecipient.addressBytes);
  }else{
    list.add(Uint8List(0));
  }
  list.add(transaction.gatewayFee);
